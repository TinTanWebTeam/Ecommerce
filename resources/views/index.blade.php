                    ...
                    <div id="so_listing_tabs_3" class="so-listing-tabs first-load module">
                        ...
                        <div class="ltabs-wrap ">
                            <div class="ltabs-tabs-container" data-delay="300" data-duration="600"
                                 ...
                                 data-ajaxurl="http://localhost/ytc_templates/opencart/so_market/" data-type_source="0">
                                <!--Begin Tabs-->
                                    ...
                                    <div class="item-sub-cat">
                                        <ul class="ltabs-tabs cf">
                                            <li class="ltabs-tab tab-sel" data-category-id="20"
                                                data-active-content=".items-category-20"><span class="ltabs-tab-label">Jewelry &amp; Watches                       </span>
                                            </li>
                                            <li class="ltabs-tab " data-category-id="18"
                                                data-active-content=".items-category-18"><span class="ltabs-tab-label">Electronics        </span>
                                            </li>
                                            <li class="ltabs-tab " data-category-id="25"
                                                data-active-content=".items-category-25"><span class="ltabs-tab-label">Sports &amp; Outdoors  </span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="ltabs-items-inner ltabs-slider ">
                                            ...
                                            <div class="product-item-container">
                                                <div class="left-block">
                                                    <div class="product-image-container second_img ">
                                                        <img src="{{ URL::to('image/demo/shop/product/J9.jpg') }}"
                                                             alt="Apple Cinema 30&quot;" class="img-responsive"/>
                                                        <img src="{{ URL::to('image/demo/shop/product/J5.jpg') }}"
                                                    ...
                                                    <div class="button-group">
                                                        <button class="addToCart" type="button" data-toggle="tooltip"
                                                                title="Add to Cart" onclick="cart.add('42', '1');"><i
                                                                    class="fa fa-shopping-cart"></i> <span class="">Add to Cart</span>
                                                        </button>
                                        ...
                                        <div class="ltabs-item product-layout">
                                            <div class="product-item-container">
                                                <div class="left-block">
                                                    <div class="product-image-container second_img ">
                                                        <img src="{{ URL::to('image/demo/shop/product/m1.jpg') }}"
                                                             alt="Apple Cinema 30&quot;" class="img-responsive"/>
                                                        <img src="{{ URL::to('image/demo/shop/product/m3.jpg') }}"
                                                             alt="Apple Cinema 30&quot;" class="img_0 img-responsive"/>
                                                    </div>
                                                    <!--New Label-->
                                        ...
                                        <div class="ltabs-item product-layout">
                                            <div class="product-item-container">
                                                <div class="left-block">
                                                    <div class="product-image-container second_img ">
                                                        <img src="{{ URL::to('image/demo/shop/product/B10.jpg') }}"
                                                             alt="Apple Cinema 30&quot;" class="img-responsive"/>
                                                        <img src="{{ URL::to('image/demo/shop/product/B9.jpg') }}"
                                                             alt="Apple Cinema 30&quot;" class="img_0 img-responsive"/>
                                                    </div>
                                                    <!--Sale Label-->
                                                    <span class="label label-sale">Sale</span>
                                        ...
                                        <div class="ltabs-item product-layout">
                                            <div class="product-item-container">
                                                <div class="left-block">
                                                    <div class="product-image-container second_img ">
                                                        <img src="{{ URL::to('image/demo/shop/product/W1.jpg') }}"
                                                             alt="Apple Cinema 30&quot;" class="img-responsive"/>
                                                        <img src="{{ URL::to('image/demo/shop/product/w10.jpg') }}"
                                                             alt="Apple Cinema 30&quot;" class="img_0 img-responsive"/>
                                                    </div>
                                        ...
                                        <div class="ltabs-item product-layout">
                                            <div class="product-item-container">
                                                <div class="left-block">
                                                    <div class="product-image-container second_img ">
                                                        <img src="{{ URL::to('image/demo/shop/product/B5.jpg') }}"
                                                             alt="Apple Cinema 30&quot;" class="img-responsive"/>
                                                        <img src="{{ URL::to('image/demo/shop/product/B10.jpg') }}"
                                                             alt="Apple Cinema 30&quot;" class="img_0 img-responsive"/>
                                                    </div>
                                    ...
                                    <div class="ltabs-items-inner ltabs-slider ">
                                        <div class="ltabs-item product-layout">
                                            <div class="product-item-container">
                                                <div class="left-block">
                                                    <div class="product-image-container second_img ">
                                                        <img src="{{ URL::to('image/demo/shop/product/e11.jpg') }}"
                                                             alt="Apple Cinema 30&quot;" class="img-responsive"/>
                                                        <img src="{{ URL::to('image/demo/shop/product/E3.jpg') }}"
                                                             alt="Apple Cinema 30&quot;" class="img_0 img-responsive"/>
                                                    </div>
                                                    <!--Sale Label-->
                                                    <span class="label label-sale">Sale</span>
                                        ...
                                        <div class="ltabs-item product-layout">
                                            <div class="product-item-container">
                                                <div class="left-block">
                                                    <div class="product-image-container second_img ">
                                                        <img src="{{ URL::to('image/demo/shop/product/141.jpg') }}"
                                                             alt="Apple Cinema 30&quot;" class="img-responsive"/>
                                                        <img src="{{ URL::to('image/demo/shop/product/11.jpg') }}"
                                                             alt="Apple Cinema 30&quot;" class="img_0 img-responsive"/>
                                                    </div>
                                        ...
                                        <div class="ltabs-item product-layout">
                                            <div class="product-item-container">
                                                <div class="left-block">
                                                    <div class="product-image-container second_img ">
                                                        <img src="{{ URL::to('image/demo/shop/product/35.jpg') }}"
                                                             alt="Apple Cinema 30&quot;" class="img-responsive"/>
                                                        <img src="{{ URL::to('image/demo/shop/product/34.jpg') }}"
                                                             alt="Apple Cinema 30&quot;" class="img_0 img-responsive"/>
                                                    </div>
                                                    <!--Sale Label-->
                                                    <span class="label label-sale">Sale</span>
                                        ...
                                        <div class="ltabs-item product-layout">
                                            <div class="product-item-container">
                                                <div class="left-block">
                                                    <div class="product-image-container second_img ">
                                                        <img src="{{ URL::to('image/demo/shop/product/E3_1.jpg') }}"
                                                             alt="Apple Cinema 30&quot;" class="img-responsive"/>
                                                        <img src="{{ URL::to('image/demo/shop/product/E3_3.jpg') }}"
                                                             alt="Apple Cinema 30&quot;" class="img_0 img-responsive"/>
                                                    </div>
                                                    <!--Sale Label-->
                                                    <span class="label label-sale">Sale</span>
                                        ...
                                        <div class="ltabs-item product-layout">
                                            <div class="product-item-container">
                                                <div class="left-block">
                                                    ...
                                                    <a class="quickview iframe-link visible-lg"
                                                       data-fancybox-type="iframe"
                                                       href="qu{{ URL::to('quickview') }}"> Quickview</a>
                                                    <!--end full quick view block-->
                                                </div>
                                                <div class="right-block">
                                                    <div class="caption">
                        ...
                        <div class="banner-wraps ">
                            <div class="m-banner row">
                                <div class="banner htmlconten1 col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="banners">
                                        <div>
                                            <a href="#"><img src="{{ URL::to('') }}image/demo/cms/banner2-1.png"
                                                             alt="banner1"></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="htmlconten2 col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="banners" style="margin-bottom:20px;">
                                        <div>
                                            <a href="#"><img src="{{ URL::to('') }}image/demo/cms/banner2-2.png"
                                                             alt="banner1"></a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="banners">
                                        <div>
                                            <a href="#"><img src="{{ URL::to('') }}image/demo/cms/banner2-3.png"
                                                             alt="banner1"></a>
                                        </div>
                                    </div>
                                ...
                                <div class="banner htmlconten3 hidden-sm col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="banners">
                                        <div>
                                            <a href="#"><img src="{{ URL::to('') }}image/demo/cms/banner2-4.png"
                                                             alt="banner1"></a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="item-sub-cat">
                                        <ul class="ltabs-tabs cf">
                                            <li class="ltabs-tab tab-sel" data-category-id="1"
                                                data-active-content=".items-category-1"><span class="ltabs-tab-label">Jewelry &amp; Watches                     </span>
                                            </li>
                                            <li class="ltabs-tab " data-category-id="2"
                                                data-active-content=".items-category-2"><span class="ltabs-tab-label">Electronics      </span>
                                            </li>
                                            <li class="ltabs-tab " data-category-id="3"
                                                data-active-content=".items-category-3"><span class="ltabs-tab-label">Sports &amp; Outdoors    </span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
