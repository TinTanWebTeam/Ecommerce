...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144"
          href="{{ URL::to('ico/apple-touch-icon-144-precomposed.png') }}">
    <link rel="apple-touch-icon-precomposed" sizes="114x114"
          href="{{ URL::to('ico/apple-touch-icon-114-precomposed.png') }}">
    <link rel="apple-touch-icon-precomposed" sizes="72x72"
          href="{{ URL::to('ico/apple-touch-icon-72-precomposed.png') }}">
    ...
    <!-- Google web fonts
    ============================================ -->
    <link href="{{ URL::to('https://fonts.googleapis.com/css?family=Open+Sans:400,700,300') }}" rel="stylesheet"
          type="text/css">
    ...
    <div id="sp-cpanel_settings">
        <div class="panel-group">
            ...
            <div class="group-schemes">
                <span data-scheme="default" class="item_scheme selected"><span
                            style="background: #e8622d;"></span></span>
        ...
        <div class="panel-group">
            ...
            <div class="group-pattern">
                <div data-pattern="28" class="img-pattern"><img src="{{ URL::to('') }}image/theme/patterns/28.png"
                                                                alt="pattern 28"></div>
                <div data-pattern="29" class="img-pattern"><img src="{{ URL::to('') }}image/theme/patterns/29.png"
                                                                alt="pattern 29"></div>
                <div data-pattern="30" class="img-pattern"><img src="{{ URL::to('') }}image/theme/patterns/30.png"
                                                                alt="pattern 30"></div>
                <div data-pattern="31" class="img-pattern"><img src="{{ URL::to('') }}image/theme/patterns/31.png"
                                                                alt="pattern 31"></div>
                <div data-pattern="32" class="img-pattern"><img src="{{ URL::to('') }}image/theme/patterns/32.png"
                                                                alt="pattern 32"></div>
                <div data-pattern="33" class="img-pattern"><img src="{{ URL::to('') }}image/theme/patterns/33.png"
                                                                alt="pattern 33"></div>
                <div data-pattern="34" class="img-pattern"><img src="{{ URL::to('') }}image/theme/patterns/34.png"
                                                                alt="pattern 34"></div>
                <div data-pattern="35" class="img-pattern"><img src="{{ URL::to('') }}image/theme/patterns/35.png"
                                                                alt="pattern 35"></div>
                <div data-pattern="36" class="img-pattern"><img src="{{ URL::to('') }}image/theme/patterns/36.png"
                                                                alt="pattern 36"></div>
                <div data-pattern="37" class="img-pattern"><img src="{{ URL::to('') }}image/theme/patterns/37.png"
                                                                alt="pattern 37"></div>
                <div data-pattern="38" class="img-pattern"><img src="{{ URL::to('') }}image/theme/patterns/38.png"
                                                                alt="pattern 38"></div>
                <div data-pattern="39" class="img-pattern"><img src="{{ URL::to('') }}image/theme/patterns/39.png"
                                                                alt="pattern 39"></div>
                <div data-pattern="40" class="img-pattern"><img src="{{ URL::to('') }}image/theme/patterns/40.png"
                                                                alt="pattern 40"></div>
                <div data-pattern="41" class="img-pattern"><img src="{{ URL::to('') }}image/theme/patterns/41.png"
                                                                alt="pattern 41"></div>
                <div data-pattern="42" class="img-pattern"><img src="{{ URL::to('') }}image/theme/patterns/42.png"
                                                                alt="pattern 42"></div>
                <div data-pattern="43" class="img-pattern"><img src="{{ URL::to('') }}image/theme/patterns/43.png"
                                                                alt="pattern 43"></div>
                <div data-pattern="44" class="img-pattern"><img src="{{ URL::to('') }}image/theme/patterns/44.png"
                                                                alt="pattern 44"></div>
                <div data-pattern="45" class="img-pattern"><img src="{{ URL::to('') }}image/theme/patterns/45.png"
                                                                alt="pattern 45"></div>
            </div>
