					...
					<div class="slider-container ">
						<div id="so-slideshow" >
							<div class="module slideshow">
								<div class="item">
									<a href="#"><img src="{{ URL::to('image/demo/slider/v2-slide1.jpg') }}" alt="slider1" class="img-responsive"></a>
								</div>
								<div class="item">
									<a href="#"><img src="{{ URL::to('image/demo/slider/v2-slide2.jpg') }}" alt="slider2" class="img-responsive"></a>
								</div>
								<div class="item">
									<a href="#"><img src="{{ URL::to('image/demo/slider/v2-slide3.jpg') }}" alt="slider3" class="img-responsive"></a>
								</div>
							</div>
				...
				<div id="yt_header_right" class="col-md-3 hidden-sm hidden-xs">
					<div class="module">
						<div class="modcontent clearfix">
							<div class="banners">
								<div>
									<a href="#"><img src="{{ URL::to('image/demo/cms/v3-banner-header.png') }}" alt="left-image"></a>
								</div>
							</div>
						</div>
					</div>
