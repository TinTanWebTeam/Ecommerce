						...
						<div class="form-group languages-block ">
							<form action="index.html" method="post" enctype="multipart/form-data" id="bt-language">
								<a class="btn btn-xs dropdown-toggle" data-toggle="dropdown">
									<img src="{{ URL::to('image/demo/flags/gb.png') }}" alt="English" title="English">
									<span class="hidden-xs">English</span>
									<span class="fa fa-angle-down"></span>
								</a>
								<ul class="dropdown-menu">
									<li><a href="#"><img class="image_flag" src="{{ URL::to('image/demo/flags/gb.png') }}" alt="English" title="English" /> English </a></li>
									<li> <a href="#"> <img class="image_flag" src="{{ URL::to('image/demo/flags/lb.png') }}" alt="Arabic" title="Arabic" /> Arabic </a> </li>
								</ul>
							</form>
						</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="navbar-logo col-md-3 col-sm-12 col-xs-12">
					<a href="index.html"><img src="{{ URL::to('image/demo/logos/theme_logo.png') }}" title="Your Store" alt="Your Store" /></a>
				</div>
				<!-- //end Logo -->
									...
									<tbody>
										<tr>
											<td class="text-center" style="width:70px">
												<a href="product.html"> <img src="{{ URL::to('image/demo/shop/product/35.jpg') }}" style="width:70px" alt="Filet Mign" title="Filet Mign" class="preview"> </a>
											</td>
										...
										<tr>
											<td class="text-center" style="width:70px">
												<a href="product.html"> <img src="{{ URL::to('image/demo/shop/product/141.jpg') }}" style="width:70px" alt="Canon EOS 5D" title="Canon EOS 5D" class="preview"> </a>
											</td>
										...
										<div class="row">
											<div class="col-md-3">
												<a href="index.html" class="image-link">
													<span class="thumbnail">
														<img class="img-responsive img-border" src="{{ URL::to('image/demo/feature/home-1.jpg') }}" alt="">
											...
											<div class="col-md-3">
												<a href="home2.html" class="image-link">
													<span class="thumbnail">
														<img class="img-responsive img-border" src="{{ URL::to('image/demo/feature/home-2.jpg') }}" alt="">
														<span class="btn btn-default">Read More</span>
													</span>
											...
											<div class="col-md-3">
												<a href="home3.html" class="image-link">
													<span class="thumbnail">
														<img class="img-responsive img-border" src="{{ URL::to('image/demo/feature/home-3.jpg') }}" alt="">
														<span class="btn btn-default">Read More</span>
													</span>
											...
											<div class="col-md-3">
												<a href="home4.html" class="image-link">
													<span class="thumbnail">
														<img class="img-responsive img-border" src="{{ URL::to('image/demo/feature/home-4.jpg') }}" alt="">
														<span class="btn btn-default">Read More</span>
													</span>
											...
											<div class="col-sm-12">
												<div class="row">
													<div class="col-md-3 img img1">
														<a href="#"><img src="{{ URL::to('image/demo/cms/img1.jpg') }}" alt="banner1"></a>
													</div>
													<div class="col-md-3 img img2">
														<a href="#"><img src="{{ URL::to('image/demo/cms/img2.jpg') }}" alt="banner2"></a>
													</div>
													<div class="col-md-3 img img3">
														<a href="#"><img src="{{ URL::to('image/demo/cms/img3.jpg') }}" alt="banner3"></a>
													</div>
													<div class="col-md-3 img img4">
														<a href="#"><img src="{{ URL::to('image/demo/cms/img4.jpg') }}" alt="banner4"></a>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-md-4">
												...
												<div class="col-sm-12 list-product">
													<div class="product-thumb">
														<div class="image pull-left">
															<a href="#"><img src="{{ URL::to('image/demo/shop/product/35.jpg') }}" width="80" alt="Filet Mign" title="Filet Mign" class="img-responsive"></a>
														</div>
														<div class="caption">
												...
												<div class="col-sm-12 list-product">
													<div class="product-thumb">
														<div class="image pull-left">
															<a href="#"><img src="{{ URL::to('image/demo/shop/product/W1.jpg') }}" width="80" alt="Dail Lulpa" title="Dail Lulpa" class="img-responsive"></a>
														</div>
														<div class="caption">
												...
												<div class="col-sm-12 list-product">
													<div class="product-thumb">
														<div class="image pull-left">
															<a href="#"><img src="{{ URL::to('image/demo/shop/product/141.jpg') }}" width="80" alt="Canon EOS 5D" title="Canon EOS 5D" class="img-responsive"></a>
														</div>
														<div class="caption">
