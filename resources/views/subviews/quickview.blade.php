                        ...
                        <div class="row">
                            <div class="content-product-left  col-sm-6 col-xs-12 ">
                                ...
                                <div id="thumb-slider" class="owl-theme owl-loaded owl-drag full_slider">
                                    ...
                                    <a data-index="2" class="img thumbnail" data-image="image/demo/shop/product/J5.jpg"
                                       title="Bint Beef">
                            ...
                            <div class="content-product-right col-sm-6 col-xs-12">
                                ...
                                <div class="box-review form-group">
                                    ...
                                    <a class="reviews_button" href="quickview.php.html"
                                ...
                                <div id="product">
                                            ...
                                            <li class="radio">
                                                <label>
                                                    <input class="image_radio" type="radio" name="option[231]"
                                                           value="33"/>
                                                    <img src="image/demo/colors/blue.jpg"
                                    ...
                                    <div class="box-checkbox form-group required">
                                        ...
                                        <div id="input-option232">
                                            <div class="checkbox">
                                                <label><input type="checkbox" name="option[232][]" value="36"/> Checkbox
                                                    1 (+$12.00) </label>
                                            </div>
                                            <div class="checkbox">
                                                <label><input type="checkbox" name="option[232][]" value="37"/> Checkbox
                                                    2 (+$36.00) </label>
                                            </div>
                                            <div class="checkbox">
                                                <label><input type="checkbox" name="option[232][]" value="38"/> Checkbox
                                                    3 (+$24.00) </label>
                                            </div>
                                            <div class="checkbox">
                                                <label><input type="checkbox" name="option[232][]" value="39"/> Checkbox
                                                    4 (+$48.00) </label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group box-info-product">
                                        ...
                                        <div class="cart">
                                            <input type="button" data-toggle="tooltip" title="" value="Add to Cart"
                                                   onclick="cart.add('42', '1');" data-loading-text="Loading..."
