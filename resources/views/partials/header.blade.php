                    ...
                    <div class="tabBlock" id="TabBlock-1">
                        <ul class="top-link list-inline">
                            ...
                            <li class="wishlist"><a href="wishlist.html" id="wishlist-total" class="top-link-wishlist"
                                                    title="Wish List (2)"><span
                                            class="hidden-xs">Wish List (2)</span></a></li>
                            ...
                            <form action="index.html" method="post" enctype="multipart/form-data" id="bt-language">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="#"><img class="image_flag"
                                                         src="{{ URL::to('image/demo/flags/gb.png') }}" alt="English"
                                                         title="English"/> English </a></li>
                                    <li><a href="#"> <img class="image_flag"
                                                          src="{{ URL::to('image/demo/flags/lb.png') }}" alt="Arabic"
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="navbar-logo col-md-3 col-sm-12 col-xs-12">
                    <a href="index.html"><img src="{{ URL::to('image/demo/logos/theme_logo.png') }}" title="Your Store"
                                              alt="Your Store"/></a>
                </div>
                <!-- //end Logo -->
                            ...
                            <li>
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        <td class="text-center" style="width:70px">
                                            <a href="product.html"> <img
                                                        src="{{ URL::to('image/demo/shop/product/35.jpg') }}"
                                    ...
                                    <tr>
                                        <td class="text-center" style="width:70px">
                                            <a href="product.html"> <img
                                                        src="{{ URL::to('image/demo/shop/product/141.jpg') }}"
                                                        style="width:70px" alt="Canon EOS 5D" title="Canon EOS 5D"
                                                        class="preview"> </a>
                                        </td>
                                        <td class="text-left"><a class="cart_product_name" href="product.html">Canon EOS
                                                5D</a></td>
                                        <td class="text-center"> x1</td>
        ...
        <div class="container">
            <div class="row">
                                                ...
                                                <li class="home hover">
													...
													<span class="thumbnail">
														<img class="img-responsive img-border"
                                                             src="{{ URL::to('image/demo/feature/home-1.jpg') }}"
                                                             alt="">
													...
													<span class="thumbnail">
														<img class="img-responsive img-border"
                                                             src="{{ URL::to('image/demo/feature/home-2.jpg') }}"
                                                             alt="">
														<span class="btn btn-default">Read More</span>
													</span>
													...
													<span class="thumbnail">
														<img class="img-responsive img-border"
                                                             src="{{ URL::to('image/demo/feature/home-3.jpg') }}"
                                                             alt="">
														<span class="btn btn-default">Read More</span>
													</span>
													...
													<span class="thumbnail">
														<img class="img-responsive img-border"
                                                             src="{{ URL::to('image/demo/feature/home-4.jpg') }}"
                                                             alt="">
														<span class="btn btn-default">Read More</span>
													</span>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="column">
                                                                        ...
                                                                        <div>
                                                                            <ul class="row-list">
                                                                                <li><a href="product.html">Image size -
                                                                                        big</a></li>
                                                                                <li><a href="product-v2.html">Image size
                                                                                        - medium</a></li>
                                                                                <li><a href="product-v3.html">Image size
                                                                                        - small</a></li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="column">
                                                                        ...
                                                                        <div>
                                                                            <ul class="row-list">
                                                                                <li><a href="cart.html">Shopping Cart
                                                                                        Page</a></li>
                                                    ...
                                                    <div class="sub-menu" style="width: 40%; ">
                                                        <div class="content">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <ul class="row-list">
                                                                        <li><a class="subcategory_item" href="faq.html">FAQ</a>
                                                                        </li>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <ul class="row-list">
                                                                        <li><a class="subcategory_item"
                                                                               href="about-us.html">About Us 1</a></li>
                                                                        <li><a class="subcategory_item"
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="row">
                                                                        <div class="col-md-3 img img1">
                                                                            <a href="#"><img
                                                                                        src="{{ URL::to('image/demo/cms/img1.jpg') }}"
                                                                                        alt="banner1"></a>
                                                                        </div>
                                                                        <div class="col-md-3 img img2">
                                                                            <a href="#"><img
                                                                                        src="{{ URL::to('image/demo/cms/img2.jpg') }}"
                                                                                        alt="banner2"></a>
                                                                        </div>
                                                                        <div class="col-md-3 img img3">
                                                                            <a href="#"><img
                                                                                        src="{{ URL::to('image/demo/cms/img3.jpg') }}"
                                                                                        alt="banner3"></a>
                                                                        </div>
                                                                        <div class="col-md-3 img img4">
                                                                            <a href="#"><img
                                                                                        src="{{ URL::to('image/demo/cms/img4.jpg') }}"
                                                                                        alt="banner4"></a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <div class="col-sm-12 list-product">
                                                                        <div class="product-thumb">
                                                                            <div class="image pull-left">
                                                                                <a href="#"><img
                                                                                            src="{{ URL::to('image/demo/shop/product/W1.jpg') }}"
                                                                                            width="80" alt="Dail Lulpa"
                                                                                            title="Dail Lulpa"
                                                                                            class="img-responsive"></a>
                                                                            </div>
                                                                            <div class="caption">
                ...
                <div class="header-bottom-right  collapsed-block col-md-4 col-sm-8 col-xs-6 ">
                    <h5 class="tabBlockTitle visible-xs">Search <a class="expander " href="#sosearchpro"><i
                                    class="fa fa-angle-down"></i></a></h5>
