<aside class="col-md-3 col-md-pull-9 col-sm-12  content-aside left_column">
                                            ...
                                            <ul class="megamenu">
                                                <li class="item-vertical style1 with-sub-menu hover">
                                                    ...
                                                    <a href="#" class="clearfix">
                                                        <img src="{{ URL::to('') }}image/theme/icons/9.png" alt="icon">
                                                ...
                                                <li class="item-vertical">
                                                    <p class="close-menu"></p>
                                                    <a href="#" class="clearfix">
                                                        <img src="{{ URL::to('') }}image/theme/icons/10.png" alt="icon">
                                                ...
                                                <li class="item-vertical with-sub-menu hover">
                                                    ...
                                                    <a href="#" class="clearfix">
                                                        ...
                                                        <img src="{{ URL::to('') }}image/theme/icons/3.png" alt="icon">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="row banner">
                                                                        <a href="#">
                                                                            <img src="{{ URL::to('') }}image/demo/cms/menu_bg2.jpg"
                                                                                 alt="banner1">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                ...
                                                <li class="item-vertical with-sub-menu hover">
                                                    <p class="close-menu"></p>
                                                    <a href="#" class="clearfix">
                                                        <img src="{{ URL::to('') }}image/theme/icons/2.png" alt="icon">
                                                ...
                                                <li class="item-vertical">
                                                    <p class="close-menu"></p>
                                                    <a href="#" class="clearfix">
                                                        <img src="{{ URL::to('') }}image/theme/icons/11.png" alt="icon">
                                                ...
                                                <li class="item-vertical">
                                                    <p class="close-menu"></p>
                                                    <a href="#" class="clearfix">
                                                        <img src="{{ URL::to('') }}image/theme/icons/4.png" alt="icon">
                                                ...
                                                <li class="item-vertical">
                                                    <p class="close-menu"></p>
                                                    <a href="#" class="clearfix">
                                                        <img src="{{ URL::to('') }}image/theme/icons/5.png" alt="icon">
                                                        <span>Smartphone &amp; Tablets</span>
                                                    </a>
                                                </li>
                                                <li class="item-vertical" style="display: none;">
                                                    <p class="close-menu"></p>
                                                    <a href="#" class="clearfix">
                                                        <img src="{{ URL::to('') }}image/theme/icons/7.png" alt="icon">
                                                ...
                                                <li class="item-vertical" style="display: none;">
                                                    ...
                                                    <a href="#" class="clearfix">
                                                        <img src="{{ URL::to('') }}image/theme/icons/6.png" alt="icon">
                                                        <span>Health &amp; Beauty</span>
                                                    </a>
                                                </li>
                                                <li class="item-vertical" style="display: none;">
                                                    <p class="close-menu"></p>
                                                    <a href="#" class="clearfix">
                                                        <img src="{{ URL::to('') }}image/theme/icons/8.png" alt="icon">
                                                ...
                                                <li class="item-vertical" style="display: none;">
                                                    <p class="close-menu"></p>
                                                    <a href="#" class="clearfix">
                                                        <img src="{{ URL::to('') }}image/theme/icons/12.png" alt="icon">
                                                ...
                                                <li class="item-vertical" style="display: none;">
                                                    <p class="close-menu"></p>
                                                    <a href="#" class="clearfix">
                                                        <img src="{{ URL::to('') }}image/theme/icons/13.png" alt="icon">
    ...
    <div class="module latest-product titleLine">
        ...
        <div class="modcontent ">
            <div class="product-latest-item">
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img src="{{ URL::to('') }}image/demo/shop/product/m1.jpg" alt="Cisi Chicken"
            ...
            <div class="product-latest-item">
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img src="{{ URL::to('') }}image/demo/shop/product/m2.jpg" alt="Cisi Chicken"
                                         title="Cisi Chicken" class="img-responsive"
                                         style="width: 100px; height: 82px;"></a>
                    </div>
                    <div class="media-body">
            ...
            <div class="product-latest-item">
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img src="{{ URL::to('') }}image/demo/shop/product/18.jpg" alt="Cisi Chicken"
                                         title="Cisi Chicken" class="img-responsive"
                                         style="width: 100px; height: 82px;"></a>
                    </div>
                    <div class="media-body">
            ...
            <div class="product-latest-item transition">
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img src="{{ URL::to('') }}image/demo/shop/product/9.jpg" alt="Cisi Chicken"
                                         title="Cisi Chicken" class="img-responsive" style="width: 100px; height:82px;"></a>
                    </div>
                    <div class="media-body">
                        <div class="caption">
        ...
        <div class="modcontent">
            <div class="block-clientsay block ">
                <div class="slider-clients-say">
                    <div class="item">
                        <div class="client-cont">Aliquam ut tellus dignissim, cursus erat ultricies tellus. Nulla tempus
                            sollicitudin mauris cursus dictum. Etiam id diam diam.
                        </div>
                        <div class="client-info"><img src="{{ URL::to('') }}image/demo/cms/client-img1.jpg" alt="">
    ...
    <div class="module">
        <div class="modcontent clearfix">
            <div class="banners">
                <div>
                    <a href="#"><img src="{{ URL::to('') }}image/demo/cms/v3-banner-home-left.jpg" alt="banner1"></a>
                </div>
            </div>
